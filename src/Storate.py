...
class Storage:
    def __init__(self, file_name: str, strategy: SerializationStrategy, 
        read_modificator: str, write_modification: str, error_exception: Exception = SyntaxError):
    ...
    def load(self) -> dict:
        ...
        except (self.error_exception, FileNotFoundError, EOFError):
            return {}
